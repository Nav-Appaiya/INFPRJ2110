...
ADMINS = (
    ('Nav Appaiya', 'navarajh@gmail.com'),
)
...
PROJECT_NAME = os.environ.get('PROJECT_NAME', 'CityGIS Portal')
HOST = os.environ.get('HOST', 'http://127.0.0.1:8002/')
...
DATABASES = {
    'default': dj_database_url.config(
        env='postgres://postgres:postgres@localhost:5432/infprj_postgres',
        default='postgres://admin:admin@localhost:5432/infprj_postgres'
    )
}
